...
namespace FoundryLanding.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            new DiscordUser("eltariel", "0540", "ellie@eltariel.com", "252040036420288512"),
            new DiscordUser("Maimakterion", "5496", "jadis.ann.smith@gmail.com", "251293654105325568"),
        };
        ...
        public IActionResult Index()
        {
            ...
            var headerUser = Models.Data.DiscordUser.MakeFromHeaders(HttpContext.Request.Headers);
